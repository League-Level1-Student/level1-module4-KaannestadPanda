...
JLabel label2;
	private void createBook() {
		...
		String yeet = "yeet.jpg";
		
		// 6. create a variable of type "JLabel" but don’t initialize it yet
		
		// 7. use the "loadImage..." methods below to initialize your JLabel
		label = loadImageFromComputer(yeet);
	...
	public void mousePressed(MouseEvent e) {
		...
		String otheryeet = "otheryeet.png";
		label2=loadImageFromComputer(otheryeet);
		// 14. pack the frame
		frame.add(label2);
		frame.pack();
		JOptionPane.showMessageDialog(null, "u bad bro");
	}
