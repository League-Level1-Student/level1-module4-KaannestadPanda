...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel panel = createHeader("h");
		// 4. Add the header component to the quizPanel
		quizPanel.add(panel);
		// 5. Add the quizPanel to the frame
		frame.add(quizPanel);
		// 6. Use the createButton method to set the value of firstButton
		firstButton = createButton("ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
		thirdButton = createButton("threeeee");
		fourthButton = createButton("Foouuuurr");
		...
		// method
		secondButton = createButton("twooooo");
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton a = new JButton(dollarAmount);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("What is the answer to life, the universe, and everything?", "42", 200);
			firstButton.setText("");
		}
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("YEEEEEEEEET", "sick trick", 400);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Otherwise
			...
			score -= prizeMoney;
			JOptionPane.showMessageDialog(null, "You're wrong, it was " + correctAnswer);
		}
